...
Welcome to `alpine` contributor's guide.
...
If you experience bugs or general issues with `alpine`, please have a look
...
You can help improve `alpine` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`alpine` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `alpine`'s files. While this mechanism can
...
```
conda create -n alpine python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/alpine.git
   cd alpine
   ```
...
5. Install [pre-commit]:
   ...
   `alpine` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/alpine
[issue tracker]: https://github.com/<USERNAME>/alpine/issues
